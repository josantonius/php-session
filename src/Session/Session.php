...
class Session {
    ...
    public static function setPrefix($prefix) {
        ...
        return (is_string(self::$_prefix = $prefix));
    }
    ...
    public static function init() {
        ...
        if (self::$_sessionStarted == false) {
            ...
            return self::$_sessionStarted = true;
        }
    ...
    public static function set($key, $value = false) {
        ...
        if (is_array($key) && $value == false) {
            ...
            foreach ($key as $name => $value) {
                ...
                $_SESSION[self::$_prefix . $name] = $value;
            }
    ...
    public static function pull($key) {
        ...
        if (isset($_SESSION[self::$_prefix . $key])) {
            ...
            $value = $_SESSION[self::$_prefix . $key];
        ...
        if (self::$_sessionStarted == true) {
            ...
            if ($key == '' && $prefix == false) {
                ...
                foreach($_SESSION as $index => $value) {
                    ...
                    if (strpos($index, self::$_prefix) === 0) {

                        unset($_SESSION[$index]);
                    }
                }

            } else { unset($_SESSION[self::$_prefix . $key]); }
